<div class="orange">
    <br>
    <h5 class="center-align color-white"><span class="text-white">TURMAS - FREQUÊNCIA</span></h5>
    <br>
</div>
...
<ul class="collapsible" data-collapsible="accordion">
    ...
    foreach ($turmas as $turmas) {
        ...
        echo '<div class="collapsible-body">
                ...
                <p class="center-align"><a href="/professor/frequenciaturma/'.$turmas['turma'].'" class="btn orange">IR PARA FREQUÊNCIA DA TURMA</a></p>
            </div>';
        echo '</li>';
    }
    ?>
